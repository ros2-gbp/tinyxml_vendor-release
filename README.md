## tinyxml_vendor (rolling) - 0.10.0-1

The packages in the `tinyxml_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling tinyxml_vendor` on `Fri, 28 Apr 2023 15:09:51 -0000`
...
## tinyxml_vendor (rolling) - 0.9.2-1

The packages in the `tinyxml_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling tinyxml_vendor` on `Tue, 14 Feb 2023 14:20:43 -0000`
...
## tinyxml_vendor (rolling) - 0.9.1-1

The packages in the `tinyxml_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling tinyxml_vendor` on `Tue, 13 Sep 2022 19:09:30 -0000`
...
## tinyxml_vendor (rolling) - 0.9.0-1

The packages in the `tinyxml_vendor` repository were released into the `rolling` distro by running `/usr/local/bin/bloom-release --non-interactive -r rolling tinyxml_vendor` on `Wed, 04 May 2022 21:38:58 -0000`
...
## tinyxml_vendor (rolling) - 0.8.3-1

The packages in the `tinyxml_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling tinyxml_vendor` on `Tue, 05 Apr 2022 17:28:24 -0000`
